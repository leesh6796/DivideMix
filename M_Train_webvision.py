...
import M_dataloader_webvision as dataloader
import torchnet
from torch.utils.tensorboard import SummaryWriter # import tensorboard summary writer
...
parser.add_argument('--num_epochs', default=1, type=int) # original 80
...
# adding ....
writer = SummaryWriter('my_logs/webvision_test/')
arg_dict = vars(args) # add
...
def train(epoch, net, net2, optimizer, labeled_trainloader, unlabeled_trainloader, netname):
    ...
    for batch_idx, (inputs_x, inputs_x2, labels_x, w_x) in enumerate(labeled_trainloader):
        ...
        # unlabeled loss is not calculated here, why?
...
def test(epoch, net1, net2, test_loader):
    ...
    # add for tensorboard visualization
    writer.add_scaler('Test/Accuracy', accs, epoch)
    return accs
...
for epoch in range(args.num_epochs + 1):
    ...
    if epoch < warm_up:
        ...
        prob1, all_loss[0] = eval_train(net1, all_loss[0]) # added
        prob2, all_loss[1] = eval_train(net2, all_loss[1]) # added
