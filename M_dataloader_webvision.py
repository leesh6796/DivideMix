...
class imagenet_dataset(Dataset):
    ...
    def __init__(self, root_dir, transform, num_class=200):
        ...
        # I will use tinyImagenet => 200 classes and each class contains 500 training images, 50 valid and 50 test images
    ...
    def __getitem__(self, index):
        ...
        # image = Image.open(data[1]).convert('RGBA')
...
class webvision_dataset(Dataset):
    def __init__(self, root_dir, transform, mode, num_class, pred=[], probability=[], log=''):
        ...
        if self.mode == 'test':
            ...
            with open(self.root + 'info/train_filelist_google_minimized2.txt', 'r') as f:
                # f.seek(0) # changed
                lines = f.readlines()
    ...
    def __getitem__(self, index):
        if self.mode == 'labeled':
            ...
            # image = Image.open(self.root + img_path).convert('RGBA')
            ...
            image = Image.open(self.root + 'val_images_resized/' + img_path).convert('RGB')
