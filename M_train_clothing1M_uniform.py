...
writer = SummaryWriter('cloth_logs/clothing1m-uniform-june6')
...
def eval_train(epoch, model):
    ...
    # Changing GMM division to random uniform division
    prob = np.random.uniform(low=0, high=1, size=(len(losses), ))
