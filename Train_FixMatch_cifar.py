...
import dataloader_FixMatch_cifar as dataloader
...
# Training
def train(epoch,net,net2,optimizer,labeled_trainloader,unlabeled_trainloader,unlabeled_trainloader2):
    net.train()
    net2.eval() #fix one network and train the other
    
    unlabeled_train_iter = iter(unlabeled_trainloader)  
    unlabeled_train_strong_iter = iter(unlabeled_trainloader2)  
    num_iter = (len(labeled_trainloader.dataset)//args.batch_size)+1
    for batch_idx, (inputs_x, inputs_x2, labels_x, w_x) in enumerate(labeled_trainloader):      
        try:
            inputs_u, inputs_u2 = unlabeled_train_iter.next()
            inputs_us, inputs_us2 = unlabeled_train_strong_iter.next()
        except:
            unlabeled_train_iter = iter(unlabeled_trainloader)
            unlabeled_train_strong_iter = iter(unlabeled_trainloader2)  
            inputs_u, inputs_u2 = unlabeled_train_iter.next()   
        ...
        inputs_us, inputs_us2 = inputs_us.cuda(), inputs_us2.cuda()
...
for epoch in range(args.num_epochs+1):   
    ...
    if epoch<warm_up:       
        ...
        print('Train Net1')
        labeled_trainloader, unlabeled_trainloader_weak, unlabeled_trainloader_strong = loader.run('train',pred2,prob2) # co-divide
        train(epoch,net1,net2,optimizer1,labeled_trainloader, unlabeled_trainloader_weak, unlabeled_trainloader_strong) # train net1  
        
        print('\nTrain Net2')
        labeled_trainloader, unlabeled_trainloader_weak, unlabeled_trainloader_strong = loader.run('train',pred1,prob1) # co-divide
        train(epoch,net2,net1,optimizer2,labeled_trainloader, unlabeled_trainloader_weak, unlabeled_trainloader_strong) # train net2         
